...
function Process(json){
  ...
  try{
    ...
    $id("jsonView").innerHTML = "<PRE class='CodeContainer'>"+html+"</PRE>";
  }catch(e){
...
function ProcessObject(obj, indent, addComma, isArray, isPropertyContent){
  ...
  if(IsArray(obj)){
    ...
    */
    html += FormatLiteral(obj.toString().split("\\").join("\\\\").split('"').join('\\"'), "", "", indent, isArray, "String");
  }
  return html;
}
...
function CollapseAllClicked(){
  EnsureIsPopulated();
  TraverseChildren($id("jsonView"), function(element){
